...
test('tcpScan() results has default controlPorts', () => {
  expect.assertions(1)
...
test('tcpScan() results has user defined controlPorts', () => {
  expect.assertions(1)
...
test('tcpScan() results contain hosts.ports with port, delta and open', () => {
  expect.assertions(3)
